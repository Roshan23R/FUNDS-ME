...
interface CreditCardProps {
  yes?: boolean; // Marked as optional
}

const CreditCard: React.FC<CreditCardProps> = ({ yes }) => {
  return (
    <>
      <div className="bg-gradient-to-tl from-gray-900 to-gray-800 text-white h-[35vh] w-[50%] p-6 rounded-xl shadow-md">
        <div className="h-full flex flex-col justify-between">
          ...
          <div className="">
            <div className="text-sm font-semibold tracking-tight">Balance</div>
      ...
      {yes && (
        <div className="relative -mt-3">
          <div className="absolute right-30 flex space-x-2 items-start bg-white text-gray-900 border-gray-200 shadow-2xl -mt-16 w-[400px] px-2 py-3 rounded-lg">
            <div className="flex-initial">
              <div className="inline-flex mt-1 items-center justify-center rounded-lg bg-gradient-to-tl from-green-400 via-green-400 bg-green-300">
                <div className="p-2">
                  <svg
