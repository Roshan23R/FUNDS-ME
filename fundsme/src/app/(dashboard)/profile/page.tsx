      ...
      <Shell>
        ...
        <section>
          <ul className="flex flex-wrap border-b border-gray-200 text-center text-sm font-medium text-gray-500 dark:border-gray-700 dark:text-gray-400">
            <li>
              <Link href="/" className=" inline-block  p-2 py-3 font-normal text-[#FFFFFF] ">Nfts</Link>
            ...
            <li>
              <Link href="/" className="inline-block p-2 py-3 font-normal text-[#FFFFFF]">Listed</Link>
              <span className=" mx-0 inline-flex h-5 w-5 items-center justify-center rounded-md bg-[#DC7DA6] text-[10px] font-normal text-[#FFFFFF]">
                0
              </span>
            </li>
            <li>
              <Link href="/" className="inline-block p-2 py-3 font-normal text-[#FFFFFF]">Offers</Link>
              <span className=" mx-0 inline-flex h-5 w-5 items-center justify-center rounded-md bg-[#DC7DA6] text-[10px] font-normal text-[#FFFFFF]">
                4
              </span>
            </li>
